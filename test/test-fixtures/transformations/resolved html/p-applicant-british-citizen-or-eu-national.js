...
<a href="/apply" role="button" draggable="false" class="govuk-button ga-event--click" data-module="govuk-button"
  ...
  <script type="module" nonce="somenonce" src="/govuk-frontend/all.js?1.2.3"></script>
  <script type="module" nonce="somenonce">
    import {initAll} from '/govuk-frontend/all.js?1.2.3'
    initAll()
  </script>
  ...
  <script nonce="somenonce" src="/dist/js/autocomplete.min.js?1.2.3"></script>
