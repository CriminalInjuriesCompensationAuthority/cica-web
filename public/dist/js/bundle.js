...
/***/ "./src/modules/ajax-request/index.js":
/*!*******************************************!*\
  !*** ./src/modules/ajax-request/index.js ***!
  \*******************************************/
...
function AjaxRequest(url, method) {
  ...
  this.data = typeof data === 'string' ? data : Object.keys(data).map(function (k) {
    return "".concat(encodeURIComponent(k), "=").concat(encodeURIComponent(data[k]));
  }).join('&');
  ...
  return new Promise(function (resolve, reject) {
    request.open(_this.method, _this.url, true);
...
function createTimeoutModal(window) {
  ...
  function updateTimeRemainingText(el, timeRemaining, interval, dialogBox) {
    ...
    var event = new CustomEvent('TIMED_OUT');
